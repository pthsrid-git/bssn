type LogbookKaunitStatus = 'Disubmit' | 'Disetujui' | 'Ditolak'
...
export interface LogbookKaunitData {
  id: number
  user_id: number
  tanggal: string
  jam_mulai: string
...
export const logbookKaunitDataFromJson = (json: any): LogbookKaunitData => {
  return {
    id: json.id,
