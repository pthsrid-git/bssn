  ...
  <div class="flex flex-col">
    ...
    <div class="relative">
      <div class="absolute inset-y-0 flex items-center pointer-events-none start-0 ps-2">
        <font-awesome-icon :icon="['fad', 'clock']" class="w-4 h-4 text-gray-500" />
      </div>
      <input
        v-model="value"
...
const inputComputedClasses = computed(() =>
  [
    'min-w-40 block w-full ps-8 pe-2.5 py-2 text-sm text-gray-900 border border-gray-300 rounded-sm bg-white focus:ring-primary-400 focus:border-primary-400 text-center',
